...
class TrainingConfig:
    ...
    seq_len: int = 8
    max_epochs: int = 2500
    # A model-only checkpoint every tenth of the run, so the evaluation sweep can draw a
    # steps-vs-pass-rate curve instead of scoring one end point. Each is named after the
    # frame it was written at.
    checkpoint_divisions: int = 10
